...
trainer = BackpropTrainer( n, dataset=trainData, verbose=True,momentum=0.01, lrdecay=1)
...
predictedA, actualA = predict(n, tstdata['input'], tstdata['target'])
fActualA, fPredictedA = nonZeroValues(actualA, predictedA)

print "MAPE: ", mape(fActualA, fPredictedA)
